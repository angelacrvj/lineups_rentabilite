...
# Fonction heatmap mise à jour
def plot_heatmap(df, title, ax=None, opponent_name=None):
    if opponent_name == "Ligue":
        fig, ax = plt.subplots(figsize=(10, 2))  # Taille spécifique pour "Ligue"
    elif ax is None:
        fig, ax = plt.subplots()  # Taille par défaut si aucun axe fourni
