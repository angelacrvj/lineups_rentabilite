...
st.set_page_config(
    page_title="Analyse Lineups Betclic Élite 🏀",
    page_icon="🏀",
    layout="wide",
)
...
#    st.write("Plongez dans un environnement conçu pour explorer, comparer et optimiser les rotations d’équipes en fonction des futurs matchups. Cet outil interactif vous permet d’accéder à des données précises et visuelles pour maximiser les performances collectives.")
...
#    """)
    ...
    **Tableaux disponibles :**
    ...
    offense_columns = {
        ...
        "centile_Pts_Tirs_Tentes_equipe": "Centile Point par tir tenté",
    ...
    defense_overall_columns = {
        ...
        "Pts_Tirs_Tentes_opp": "Point par tir tenté",
